...
# Saving settings
use_CBF_filter = True
save_folder = 'training_performance_comp/map0/at1/single_with_filter'
...
# seed and iter
expert_seeds = [4864, 4864, 4864, 4864, 4864] # Generate by random.randrange(0, 10000, 1), executed for 5 times
                    ...
                    if use_CBF_filter:
                        ...
                        if online_ego_oppo_collision_check:
                            ...
                            if step_num >= 1:
                                ...
                                #conflict_check_scoring_and_resolution(scan, expert_ego_action, curr_vel_x, curr_vel_y, CBF_value, dataset)
                        ...
                        if step_num_left >= 1:
                            ...
                            curr_vel_x = obs["linear_vels_x"][0]
                            curr_vel_y = obs["linear_vels_y"][0]
                            #conflict_check_scoring_and_resolution(scan, expert_ego_action, curr_vel_x, curr_vel_y, CBF_value_border, dataset)
