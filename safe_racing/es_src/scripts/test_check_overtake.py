...
high_speed_overtake_prob = 0 # Probability of high speed overtaking
...
for i in range(num_iter):
    ...
    while not done and laptime < 8:
        ...
        while not done and tracker_count < lane_switcher_conf.tracker_steps:
            ...
            # oppo_upper_right_x, oppo_upper_right_y = utils.prepare_ego_oppo_coordinates_for_overtaking_check(env, ego_x, ego_y, ego_theta, oppo_x, oppo_y, oppo_theta)
            # utils.check_if_successful_overtake(env, ego_x, ego_y, ego_theta, oppo_x, oppo_y, oppo_theta)
            ...
            # Render closest pts
            if render_sim:
                vl1 = utils.render_line(env, left_oppo_scan_x, left_oppo_scan_y, oppo_x, oppo_y, color=(255, 0, 0))
                vl2 = utils.render_line(env, right_oppo_scan_x, right_oppo_scan_y, oppo_x, oppo_y, color=(0, 255, 0))
...
# print("Percentage of iterations ego collide with environment: ", num_ego_env_collision/num_iter)
# print("Percentage of iterations ego collide with opponent: ", num_ego_oppo_collision/num_iter)
